...
🚀 **Coba Sekarang!**  
Copy code di atas dan test hasilnya di: **[https://zapp.run/](https://zapp.run/)**
...
🚀 **Coba Sekarang!**  
Silakan copy code Lists di atas dan eksperimen di: **[https://zapp.run/](https://zapp.run/)**
...
🚀 **Coba Sekarang!**  
Test implementasi Maps ini di: **[https://zapp.run/](https://zapp.run/)** dan lihat cara kerja key-value pairs!
...
🚀 **Coba Sekarang!**  
Eksperimen dengan Sets di: **[https://zapp.run/](https://zapp.run/)** dan lihat bagaimana duplikat otomatis dihapus!
...
#### 💻 Implementasi Future dan Async/Await
...
🚀 **Coba Sekarang!**  
Test async programming ini di: **[https://zapp.run/](https://zapp.run/)** dan perhatikan delay yang terjadi!
...
🚀 **Coba Sekarang!**  
Bandingkan perbedaan waktu sequential vs parallel di: **[https://zapp.run/](https://zapp.run/)**
...
🚀 **Coba Sekarang!**  
Test semua skenario error handling di: **[https://zapp.run/](https://zapp.run/)** dan lihat bagaimana exception ditangani!
...
🚀 **Coba Sekarang!**  
Copy class structure di atas dan test di: **[https://zapp.run/](https://zapp.run/)**
...
🚀 **Coba Sekarang!**  
Implementasikan BMI Calculator logic di: **[https://zapp.run/](https://zapp.run/)**
...
flowchart TD
    ...
    F --> G[🧮 Calculate BMI]
    G --> H{❓ BMI Category?}
    H -->|"< 17"| I[🏷️ Kurus Berat]
    H -->|"17-18.4"| J[🏷️ Kurus Ringan]
    H -->|"18.5-25"| K[🏷️ Normal]
    H -->|"25.1-27"| L[🏷️ Gemuk Ringan]
    H -->|"> 27"| M[🏷️ Gemuk Berat]
    
    I --> N[💡 Generate Recommendation]
    J --> N
    K --> N
    L --> N
    M --> N
    
    N --> O[📊 Create BMIResult Object]
    O --> P[💾 Save to History]
    P --> Q[📈 Update Statistics]
    Q --> R[✅ Return BMIResult]
    ...
    style K fill:#e8f5e8,stroke:#2e7d32,stroke-width:2px,color:#000
    style L fill:#fff8e1,stroke:#f57f17,stroke-width:2px,color:#000
    style M fill:#ffebee,stroke:#c62828,stroke-width:2px,color:#000
...
#### 💻 Complete BMI Calculator Application
...
🚀 **Coba Sekarang!**  
Jalankan complete BMI Calculator application di: **[https://zapp.run/](https://zapp.run/)** dan lihat bagaimana semua konsep OOP, Collections, Async, dan Exception Handling bekerja bersama!
...
flowchart TD
    ...
    L --> M{❓ More Students?}
    M -->|Ya| D
    M -->|Tidak| N[🛡️ Error Handling Test]
...
3. **Koding Indonesia**. (2025). *Tutorial Dart OOP Bahasa Indonesia Lengkap*. https://kodingindonesia.com/tutorial-dart-oop-bahasa-indonesia/

4. **Dicoding Indonesia**. (2024). *Memulai Pemrograman dengan Dart*. https://www.dicoding.com/academies/191

### 🛠️ Tools dan Resources

5. **DartPad Online Editor**. (2025). *Try Dart in your browser*. https://dartpad.dev

6. **Zapp.run**. (2025). *Online Flutter playground*. https://zapp.run/
...
5. **🧪 Test Your Code**: Selalu test di **[https://zapp.run/](https://zapp.run/)** sebelum submit
